...
- Google Search Console에 `https://jinminseong.com`을 등록합니다.
- Sitemap URL은 `https://jinminseong.com/sitemap-index.xml`입니다.
- RSS URL은 `https://jinminseong.com/rss.xml`입니다.
